...
namespace ProgectTemplate.HttpHelper.JsonExtension
{
    public static class NewtonsoftExtension
    {
        public static IEnumerable<T> ToListCustom<T>(this JToken param)
        {
            try
            {
                ...
                JArray jsonVal = JArray.Parse(param.ToString());
        ...
        {
            return (T)JsonConvert.DeserializeObject(param.ToString(), typeof(T));
        }
    ...
    public static class JsonConverter<T> where T : class
    {
        ...
        public static IEnumerable<T> ToListCustom(JToken param)
        {
            return param.ToListCustom<T>();
        }

        public static T DeserializeObjectCustom<T>(JToken param)
        {
            return param.DeserializeObjectCustom<T>();
        }
